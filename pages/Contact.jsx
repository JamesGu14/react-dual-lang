...
*/}
            ...
            <div className="trd-office-addresses-wrapper col-md-4 col-md-offset-1 col-sm-6 col-xs-12">
                ...
                <div className="trd-office-address">
                  <h3 className="trd-office-title">Adelaide</h3>
                  <ul>
                    <li className="trd-office-location">Address: 232 Hutt Street, Adelaide, South Australia 5000, Australia</li>
                    <li className="trd-office-phone">Phone number: +61 (08) 8223 3114</li>
                    <li className="">Fax number: +61 (08) 8223 2574</li>
                    <li className="trd-office-phone">Website: www.foryoung.com.au</li>
                    <li>Email: <a href="mailto:admin@foryoung.com.au" target="_blank">admin@foryoung.com.au</a></li>
                  </ul>
                </div>
                {/*  END  */}
